...
mid가 나쁜버전이라면 mid 이전의 버전에 최초의 나쁜버전이 있다는 말이기 때문에 mid가 다시 right가 되어 1부터 right까지 다시 검사하고
mid가 나쁜버전이 아니라면 mid 이후의 버전에 최초의 나쁜버전이 있다는 말이기 때문에 mid + 1 부터 right 까지 다시 검사한다.
